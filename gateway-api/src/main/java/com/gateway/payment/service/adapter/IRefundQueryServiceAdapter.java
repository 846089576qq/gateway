 ...
 */
public interface IRefundQueryServiceAdapter extends IBaseServiceAdapter {
	 ...
	 * @throws ServiceException
	 */
	Map<String, Object> checkQueryPermission(String merchantId, String applicationId, String gatewayId, String serialNo) throws ServiceException;
