...
import com.gateway.payment.service.adapter.IQueryChannelServiceAdapter;
...
public class QueryChannelController extends BaseController {

	private static final Logger logger = LoggerFactory.getLogger(QueryChannelController.class);

	@Reference
	IQueryChannelServiceAdapter queryChannelServiceAdapter;
