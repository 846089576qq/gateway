...
public class QueryController extends BaseController {
	...
	@Reference
	IQueryServiceAdapter queryServiceAdapter;
	...
	public String jsonPayment(HttpServletRequest request, HttpEntity<String> entity) {
		...
		try {
			...
			Map<String, Object> permissionMap = queryServiceAdapter.checkQueryPermission(merchantId, applicationId, rd.getSerialNo());
			...
			Map<String, Object> queryResultMap = queryServiceAdapter.execQuery(zitopayPerson, zitopayPersonApplication, paramMap, rd.getSerialNo());
	...
	public String checkOrder(HttpServletRequest request) {
		queryServiceAdapter.allunpayingOrderScheduler(request.getParameter("threeorderid"));
		return "ok";
	}
}
