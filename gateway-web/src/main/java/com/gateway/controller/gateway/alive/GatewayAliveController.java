package com.gateway.controller.gateway.alive;
...
public class GatewayAliveController {

	private static final Logger logger = LoggerFactory.getLogger(GatewayAliveController.class);
