...
@Gateway(gatewayId = IBaseService.BEAN_PREFIX_ISSUED + GatewayConstants.GATEWAY_YSF_NO_ICON_WG)
public class YsfNoZitopayIconWGIssuedServiceImpl extends BaseIssuedServiceImpl implements IYsfWGIssuedService {
