...
@Gateway(gatewayId = IBaseService.BEAN_PREFIX_PAY + GatewayConstants.GATEWAY_YSF_NO_ICON_WG_2)
public class YsfNoZitopayIconWG2PaymentServiceImpl extends BaseysfPaymentServiceImpl implements IYsfWGPamentService {
