...
@Gateway(gatewayId = IBaseService.BEAN_PREFIX_ISSUED + GatewayConstants.GATEWAY_YSF_NO_ICON_WG_2)
public class YsfNoZitopayIconWG2IssuedServiceImpl extends BaseIssuedServiceImpl implements IYsfWGIssuedService {
