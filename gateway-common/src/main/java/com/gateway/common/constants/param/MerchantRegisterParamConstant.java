 ...
 * 商户入驻参数常量类
 * 
 * 作者：王政 创建时间：2017年3月15日 上午10:52:18
 */
public class MerchantRegisterParamConstant {
	 ...
	 * mer_email 商户邮箱
	 */
	public static final String param_merEmail = "mer_email";
	...
	/**
	 * fix_fee 单笔提现手续费（固定值单位：元）
	 */
	public static final String param_withdrawFixFee = "withdraw_fix_fee";

	/**
	 * withdraw_rate 提现费率
	 */
	public static final String param_withdrawRate = "withdraw_rate";

	/**
	 * empl_config 商户代理配置(json)
	 */
	public static final String param_emplConfig = "empl_config";
